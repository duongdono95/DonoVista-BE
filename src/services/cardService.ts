...
const createNew = async (validatedRequest: Omit<z.infer<typeof CardSchemaZodWithID>, '_id'>) => {
    try {
...
const updateCard = async (cardId: string, updateCard: z.infer<typeof CardSchemaZodWithID>) => {
    try {
